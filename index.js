...
function reloadClass(classDay, classTime) {
  var targetHTML = $("#class-".concat(classDay, "-").concat(classTime));
...
$(".class-button").click(function (target) {
  $("#sign-title-day").html($(target).attr("data-day"));
  $("#sign-title-time").html($(target).attr("data-time-readable"));
  var classDay = $(target).attr("data-day");
  var classTime = $(target).attr("data-time");
...
$("#class-delete").click(function (e) {
  var classDay = parseInt($("#class-day").val());
  var classTime = parseInt($("#class-time").val());
...
$("#class-import").click(function (e) {
  $("#class-import-file").click();
});
$("#class-import-file").change(function (e) {
  var files = $("#class-import-file").prop('files');
...
module.exports = __webpack_require__(/*! C:\Work Station\Web Projects\TimetableGenerator\src\js\index.js */"./src/js/index.js");
